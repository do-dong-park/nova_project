...
$sql = mq("select bi.board_no, bi.title,bi.content, mi.nickname,mi.id, bi.CreateDate, bi.board_category, bi.hit from php_real_project.board_info as bi join php_real_project.member_info as mi where bi.board_no='" . $bno . "' and mi.member_no = bi.writer_code "); /* 받아온 idx값을 선택 */
