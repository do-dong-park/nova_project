...
//    test1이란 작성자로만 작성중임.
    ...
    $sql = mq("insert into php_real_project.board_info(board_category, title, writer_code, reply_count, content, file_no, CreateDate, UpdateDate, hit, category, group_no, group_seq, group_depth, use_secret) values(0,'".$title."',1,0,'".$content."',null,now(),now(),0,0,'".$group_no."','".$bno."','".$group_depth."'+1,'".$lock_post."')");
