...
//    test1이란 작성자로만 작성중임.
    ...
    $sql = mq("insert into php_real_project.reply(board_no, comment_writer, reply_content, reply_createDate, reply_modifyDate, reply_use_secret, reply_group_no, reply_group_seq, reply_group_depth) values('".$bno."',1,'".$content."',now(),null,0,'".$group_no."','".$rno."','".$group_depth."'+1)");
